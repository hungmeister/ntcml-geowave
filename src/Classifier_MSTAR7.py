...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv_block1 = [nn.Conv2d(1, 100, 5, padding=2), nn.ReLU()]
        for i in range(5):
            self.conv_block1 = self.conv_block1 + [nn.Conv2d(100, 100, 5, padding=2), nn.ReLU()]
        ...
        self.conv_block2 = nn.Sequential(
            nn.Conv2d(100, 100, 5, padding=2),
            nn.ReLU(),
            nn.Conv2d(100, 64, 5, padding=2),
            nn.ReLU(),
            nn.MaxPool2d(6, 6),
            Flatten()
        )
