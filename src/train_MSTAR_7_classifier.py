...
# Src path
source_path = os.path.abspath(os.path.join('/dcos/volume0/geowave/ntcml-geowave/src/'))
...
if __name__ == "__main__":
    ...
    optimizer = optim.SGD(net.parameters(), lr=SOFTMAX_LR, momentum=SOFTMAX_MOMENTUM, weight_decay=0.0)  # lr = .001
    ...
    # Initialize datasets
    trainset = MSTAR_7_Dataset.MSTAR_7_Dataset(train_dataset)

    testset = MSTAR_7_Dataset.MSTAR_7_Dataset(test_dataset)
